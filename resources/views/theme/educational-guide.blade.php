...
@push('head')
    @include('theme.components.banner', [
        'banner' => isset($page->banner)
            ? asset('storage/' . $page->banner)
            : asset('assets/img/service-banner.png'),
...
@section('content')
                ...
                <div class="col-md-10 mx-auto">
                    ...
                    <div class="row py-4">
                        <div class="d-flex flex-columns justify-content-center">
                            <h6 class="sub-heading">Educational Guide</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="text-center">
                            <h1 class="title pb-4">{{ $page->name ?? 'Nanosoft Educational Guide' }}</h1>
                            <span
                                class="fs-4 text-black-50">{{ $page->tagline ??
                                    'Our official educational guides with news, technology advice, and business
                                                                culture.' }}</span>
                        </div>
                    </div>
    ...
    <section class="news-card-section mt-5">
        <div class="container">
