...
<head>
    ...
    {{-- Layout: app.blade.php - Main Admin Layout --}}
    <title>@yield('title', 'Admin | Nanosoft')</title>
    ...
    <style>
        ...
        .dataTables_length {
            /* Page length dropdown container */
...
<body>
    ...
    <header class="top-header">
        <nav class="navbar navbar-expand align-items-center gap-4">
            ...
            <div class="search-bar flex-grow-1">
                {{-- Optional: Insert global search if needed --}}
            </div>
            <ul class="navbar-nav gap-1 nav-right-links align-items-center">
                ...
                <li class="nav-item dropdown">
                    <a href="javascript:;" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
                        <img src="{{ asset('theme/assets/images/avatars/01.png') }}" class="rounded-circle p-1 border" width="45"
                            height="45" />
                    </a>
                    <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                        <a class="dropdown-item gap-2 py-2" href="javascript:;">
                            <div class="text-center">
                                <img src="{{ asset('theme/assets/images/avatars/01.png') }}" class="rounded-circle p-1 shadow mb-3"
    ...
    <aside class="sidebar-wrapper">
        <div class="sidebar-header">
            <div class="logo-icon">
                <img src="{{ asset('theme/assets/images/logo-icon.png') }}" class="logo-img" alt="Logo" />
            </div>
