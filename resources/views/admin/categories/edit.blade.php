                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="category-slug" name="slug" value="{{ old('slug', $category->slug) }}">
                        </div>
                        <div class="mb-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-3">
                            <a href="{{ route('admin.categories.index') }}" class="btn btn-outline-danger flex-fill">Discard</a>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="meta_title" id="meta-title"
                                       value="{{ old('meta_title', optional($category->meta)->meta_title) }}" placeholder="Meta Title">
                            </div>
                            <div class="col-12">
                                <label for="meta-description" class="form-label">Meta Description</label>
                                <textarea class="form-control" name="meta_description" cols="4" rows="6" placeholder="Write a description here..">{{ old('meta_description', optional($category->meta)->meta_description) }}</textarea>
                            </div>
                            <div class="col-12">
                                <label for="keywords" class="form-label">Meta Keywords</label>
                                <input type="text" class="form-control" name="meta_keywords" id="keywords"
                                       value="{{ old('meta_keywords', optional($category->meta)->meta_keywords) }}" placeholder="Keywords">
                            </div>
                        </div>
                    </div>
                </div>
