...
<div class="main-content">
    ...
    <form action="{{ route('admin.locations.update', $location->id) }}" method="POST" class="ajax-form">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="address" class="form-control" rows="4">{{ $location->address }}</textarea>
                </div>
