                ...
                <div class="col-12 col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <label for="is_guide">
                                    <input type="checkbox" name="is_guide" id="is_guide" @selected($news->is_guide)>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" name="intro" cols="4" rows="6" placeholder="write a intro here..">{{ $news->intro }}</textarea>
                            </div>

                            <div class="mb-4">
                                <h5 class="mb-3">Content</h5>
                                <textarea class="form-control rich-editor" name="content" cols="4" rows="6"
                                    placeholder="write a content here..">{{ $news->content }}</textarea>
                            </div>
                            <div class="mb-4">
                                ...
                                <select name="tags[]" id="tags" class="form-control" multiple>
                                    @foreach ($tags as $tag)
                                        <option value="{{ $tag->name }}"
                                            {{ in_array($tag->name, old('tags', $news->tags->pluck('name')->toArray())) ? 'selected' : '' }}>
                                            {{ $tag->name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-3">
                                <a href="{{ route('admin.news.index') }}" class="btn btn-outline-danger flex-fill">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="meta_title" id="meta-title"
                                        value="{{ old('meta_title', optional($news->meta)->meta_title) }}"
                                        placeholder="Meta Title">
                                </div>
                                <div class="col-12">
                                    <label for="meta-description" class="form-label">Meta Description</label>
                                    <textarea class="form-control" name="meta_description" cols="4" rows="6"
                                        placeholder="Write a description here..">{{ old('meta_description', optional($news->meta)->meta_description) }}</textarea>
                                </div>
                                <div class="col-12">
                                    <label for="keywords" class="form-label">Meta Keywords</label>
                                    <input type="text" class="form-control" name="meta_keywords" id="keywords"
                                        value="{{ old('meta_keywords', optional($news->meta)->meta_keywords) }}"
